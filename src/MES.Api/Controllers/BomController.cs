...
public class BomController : ControllerBase
{
    ...
    [HttpPost]
    public async Task<IActionResult> Create([FromBody] CreateBomRequest request)
    {
    ...
    [HttpPut("{id}")]
    public async Task<IActionResult> Update(long id, [FromBody] UpdateBomRequest request)
    {
