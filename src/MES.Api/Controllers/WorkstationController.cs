...
public class WorkstationController : ControllerBase
{
    ...
    public WorkstationController(IWorkstationService service) => _service = service;
    ...
    public async Task<IActionResult> GetById(long id)
    {
        ...
        if (dto == null) return NotFound(ApiResponse.Fail("工位不存在"));
    ...
    {
        var list = await _service.GetByLineIdAsync(lineId);
        return Ok(ApiResponse.Ok(list));
    }
